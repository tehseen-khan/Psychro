...
f21 = Frame(f2, borderwidth=2)

f22 = Frame(f2, borderwidth=2)

TDB_label = Label(f21, text='Enter Dry Bulb Temperature °C ')
TWB_label = Label(f22, text='Enter Wet Bulb Temperature °C ')


TDB_label.pack(side='left')
TWB_label.pack(side='left', padx=5)
f21.pack(fill='x', pady=2)
#f22.pack(fill='x', pady=2)
